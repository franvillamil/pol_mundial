...
\begin{itemize}
  \item \textbf{Agravios} (\textit{grievances}):
  \begin{itemize}
    \item Exclusión política, discriminación étnica o religiosa, represión
  \end{itemize}
  \item<2-> \textbf{Codicia} (\textit{greed}):
  \begin{itemize}
    \item Control de recursos naturales (diamantes, petróleo, minerales)
  \end{itemize}
  \item<3-> Pero casi todos los países tienen grupos descontentos
  \item<3-> ¿Por qué solo en algunos hay rebelión?
\end{itemize}
...
\vspace{15pt}
\footnotesize ¿Es solo la pobreza, o hacen falta más factores?
...
Coerción & Imponer costes al enemigo para forzar concesiones \\[6pt]
\onslide<2->{Provocación & Provocar una respuesta desproporcionada del Estado que aliene a la población} \\[6pt]
\onslide<3->{Spoiling & Sabotear un proceso de paz que perjudica al grupo} \\[6pt]
...
\begin{itemize}
  \item Una respuesta \textbf{demasiado dura} puede ser contraproducente
  \begin{itemize}
  ...
  \end{itemize}
  \item<2-> Una respuesta \textbf{demasiado blanda} puede señalar debilidad
  \begin{itemize}
...
\vspace{15pt}
\footnotesize ¿Cayó en la trampa de la provocación?
