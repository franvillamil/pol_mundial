...
\begin{itemize}
  \item Las \textbf{guerras civiles} son el tipo de conflicto dominante hoy
  \begin{itemize}
    \item Agravios, codicia, Estados débiles, apoyo externo
    \item Los problemas de compromiso las hacen especialmente duraderas
  \end{itemize}
  \item<2-> El \textbf{terrorismo} es una estrategia del débil contra el fuerte
  \begin{itemize}
    \item Coerción, provocación, spoiling, outbidding
  \end{itemize}
  \item<3-> El modelo de negociación sigue siendo útil para entender por qué la violencia persiste
\end{itemize}

\end{frame}
% ----------------------------------------------------
\note{Cierre del bloque de violencia política (sesiones 3-5):
\begin{enumerate}
  \item Sesión 3: por qué hay guerras interestatales (modelo de negociación, tres causas del fracaso)
  \item Sesión 4: el papel de la política doméstica, la democracia y las organizaciones internacionales
  \item Sesión 5: la violencia intraestatal y el terrorismo
\end{enumerate}
Hilo conductor: la misma lógica analítica (intereses en conflicto + fallos en la negociación) se aplica a todos los niveles. La próxima semana: leyes, normas y derechos humanos -- pasamos de la violencia a las reglas que intentan limitarla.}
