...
\begin{itemize}
  ...
  \item Mecanismos de rendición de cuentas: CPI, CEDH y justicia transicional
\end{itemize}
\end{frame}
% ----------------------------------------------------
\note{}
...
{\large ¿Puedes pensar en una norma que esté hoy\\en la primera fase --- la de los emprendedores de normas?}
...
\vspace{6pt}
\onslide<2->{\small Cada hito expande la norma: más actores, más tipos de delitos, más jurisdicciones}
...
\begin{itemize}
  ...
  \item \textbf{CPI (2002):} primer tribunal permanente con jurisdicción universal
\end{itemize}}
...
\begin{itemize}
  ...
  \item Una nueva \textbf{norma internacional}: la responsabilidad \textbf{criminal individual}
  \begin{itemize}
    \item Los líderes son personalmente responsables de las violaciones de DDHH
  \end{itemize}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=\paperheight]{../img/justice_cascade.jpg}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
...
% ----------------------------------------------------
\begin{frame}
\frametitle{CPI y CEDH: dos modelos de rendición de cuentas}
\centering
...
\vspace{10pt}
\onslide<2->{\small ¿Por qué el CEDH funciona mejor? Los miembros comparten valores\\y hay costes reales por incumplir}

\end{frame}
% ----------------------------------------------------
\note{El contraste CPI/CEDH es la lección clave de esta sección:
\begin{itemize}
...
\vspace{10pt}
\onslide<2->{\small \textbf{Las comisiones de verdad} intentan combinar ambas lógicas:\\
...
\begin{itemize}
  ...
  \item<3-> \textbf{Instituciones:} el DI reduce la incertidumbre y crea expectativas; la CPI y la CEDH institucionalizan la rendición de cuentas; la R2P reconcilia soberanía con DDHH
\end{itemize}
