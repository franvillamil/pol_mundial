...
% ====================================================
\section{Debate 1: ¿Vuelve la guerra entre grandes potencias?}
% ====================================================
...
¿Estamos viendo el fin de ese período excepcional?}
\end{frame}
% ----------------------------------------------------
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Disuasión nuclear (amenazas explícitas)
    \item Interdependencia económica $\neq$ paz
  \end{itemize}
  \vspace{6pt}
  \item<3-> Respuesta: \textbf{sanciones} sin precedentes (SWIFT, reservas congeladas)
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Argumentos del debate}
\centering

\begin{columns}[T]
\begin{column}{0.47\textwidth}
\textcolor{accent2}{\textbf{Sí, vuelve la guerra}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
  \item Ucrania: precedente vivo
...
\end{column}
\begin{column}{0.47\textwidth}
\textcolor{accent}{\textbf{No, la paz aguanta}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
  \item MAD sigue funcionando
  \item Comercio EEUU--China enorme
...
\vspace{10pt}
\onslide<2->{\centering\small \textit{Conexión con el curso: bargaining (t.03), alianzas y paz democrática (t.04)}}
\end{frame}
% ----------------------------------------------------
...
% ====================================================
\section{Debate 2: ¿Puede el mundo cooperar ante bienes públicos globales?}
% ====================================================
...
\begin{itemize}
  ...
  \item<4-> \textbf{Productos conjuntos} (beneficios adicionales)
  \item<5-> \textbf{Grupo privilegiado} (líder dispuesto a pagar)
\end{itemize}

\vspace{10pt}
\onslide<6->{\small El \textcolor{accent}{Protocolo de Montreal (1987)} cumplía los cinco. El \textcolor{accent2}{clima} solo cumple, con suerte, el tercero.}
\end{frame}
% ----------------------------------------------------
...
\begin{itemize}
  ...
  \end{itemize}
  \vspace{6pt}
  \item<3-> 2024: \textbf{Acuerdo Pandémico} en la OMS\dots aún parcial y sin compromisos vinculantes
  \vspace{6pt}
  \item<4-> \alert{El próximo patógeno llegará; las instituciones siguen débiles}
\end{itemize}
\end{frame}
% ----------------------------------------------------
...
\begin{columns}[T]
\begin{column}{0.47\textwidth}
\textcolor{accent}{\textbf{Sí, podemos cooperar}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
...
\end{column}
\begin{column}{0.47\textwidth}
\textcolor{accent2}{\textbf{No, estamos atrapados}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
...
\vspace{10pt}
\onslide<2->{\centering\small \textit{Conexión con el curso: normas y derecho internacional (t.06)}}
\end{frame}
% ----------------------------------------------------
...
% ====================================================
\section{Debate 3: ¿Es reversible la globalización?}
% ====================================================
...
\begin{itemize}
  ...
  \vspace{6pt}
  \item<3-> \textbf{Aranceles EEUU a China:} $\sim$3\% en 2017 $\to$ $\sim$20\% en 2020 $\to$ nuevas rondas 2024--2026
  \vspace{6pt}
  \item<4-> \textbf{Sanciones activas:} récord histórico (Rusia, Irán, NK, China tech)
\end{itemize}
...
\begin{itemize}
  ...
  \vspace{6pt}
  \item<3-> ¿Qué sigue integrado?
  \begin{itemize}
    \item Bienes de consumo (ropa, electrónica de gama baja)
    \item Tierras raras y procesamiento
  \end{itemize}
  \vspace{6pt}
  \item<4-> ¿Qué se separa?
  \begin{itemize}
    \item Semiconductores avanzados
    \item IA, computación cuántica
    \item Flujos de capital sensibles
  \end{itemize}
\end{itemize}
\end{frame}
% ----------------------------------------------------
...
\begin{columns}[T]
\begin{column}{0.47\textwidth}
\textcolor{accent2}{\textbf{Sí, se revierte}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
...
\end{column}
\begin{column}{0.47\textwidth}
\textcolor{accent}{\textbf{No, se reconfigura}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
...
\vspace{10pt}
\onslide<2->{\centering\small \textit{Conexión con el curso: comercio (t.07), finanzas y weaponized interdependence (t.08)}}
\end{frame}
% ----------------------------------------------------
...
% ====================================================
\section{Debate 4: ¿Sigue funcionando el orden liberal?}
% ====================================================
...
\begin{enumerate}
  ...
  \begin{itemize}
    \item Rusia, Corea del Norte, Irán
  \end{itemize}
...
\vspace{8pt}
\onslide<3->{\small \textcolor{asher}{Frieden, Lake \& Schultz, cap.~14}}
\end{frame}
% ----------------------------------------------------
...
\begin{itemize}
  ...
  \end{itemize}
  \vspace{6pt}
  \item<4-> \alert{Paradoja:} sin gobernanza global comparable a OMC o FMI
\end{itemize}
\end{frame}
% ----------------------------------------------------
...
\begin{itemize}
  ...
  \vspace{6pt}
  \item<3-> \textbf{OMS:} salida y reentrada de EEUU, acuerdo pandémico débil
  \vspace{6pt}
  \item<4-> \textbf{OTAN:} reactivada por Ucrania, pero cuestionada desde dentro (EEUU)
\end{itemize}

\vspace{8pt}
\onslide<5->{\small \textit{¿Reforma, sustitución o erosión lenta?}}
\end{frame}
% ----------------------------------------------------
...
\begin{columns}[T]
\begin{column}{0.47\textwidth}
\textcolor{accent2}{\textbf{El orden está en crisis}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
...
\end{column}
\begin{column}{0.47\textwidth}
\textcolor{accent}{\textbf{El orden resiste}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
...
\vspace{10pt}
\onslide<2->{\centering\small \textit{Conexi\'on con el curso: post-1945 (t.01), DDHH y R2P (t.06)}}
\end{frame}
% ----------------------------------------------------
...
% ====================================================
\section{Debate 5: Nuevas fronteras --- nuclear, cyber, IA}
% ====================================================

% ----------------------------------------------------
\begin{transitionframe}
Debate 5\\
Nuevas fronteras: nuclear, cyber, IA
\end{transitionframe}
% ----------------------------------------------------
\note{}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Fin de tratados de control (INF, New START en duda)
  \end{itemize}
\end{itemize}
\end{frame}
% ----------------------------------------------------
...
\begin{itemize}
  ...
  \item Irán: programa activo
  \item Los P5 no desarman
\end{itemize}
\end{column}
\end{columns}

\vspace{10pt}
\onslide<2->{\centering\small Caso 2024--2026: \textbf{Irán} como pr\'oxima crisis nuclear}
\end{frame}
% ----------------------------------------------------
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Ciberamenazas: disuasión sin atribución}
\centering
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Casos que cambiaron el tablero}
\centering
...
% ----------------------------------------------------
\begin{frame}
\frametitle{IA: ¿la próxima carrera geopolítica?}
\centering

\begin{itemize}
  \item<1-> \textbf{Tecnología transformadora}, comparable a la electricidad
  \vspace{6pt}
  \item<2-> Dimensión militar: armas autónomas, drones, ciberdefensa
  \item<3-> Dimensión económica: productividad, automatización
  \item<4-> Dimensión geopolítica:
  \begin{itemize}
...
\begin{columns}[T]
\begin{column}{0.47\textwidth}
\textcolor{accent2}{\textbf{Las nuevas fronteras son inestables}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
  \item Sin reglas claras
  \item Actores no estatales
  \item Tecnolog\'\i a m\'as r\'apida que regulaci\'on
  \item Proliferaci\'on nuclear vuelve
\end{itemize}
\end{column}
\begin{column}{0.47\textwidth}
\textcolor{accent}{\textbf{Se estabilizarán}}
\begin{itemize}
  \setlength{\itemsep}{5pt}
  \item Los Estados aprenden
  \item Aparecen normas informales
  \item Interés mutuo en evitar catástrofe
  \item Precedente del TNP
\end{itemize}
\end{column}
\end{columns}

\vspace{10pt}
\onslide<2->{\centering\small \textit{Conexi\'on con el curso: actores no estatales (t.05), bargaining (t.03)}}
\end{frame}
% ----------------------------------------------------
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Conexiones cruzadas}
\centering

\begin{itemize}
  \setlength{\itemsep}{6pt}
  \item<1-> \textbf{Taiwán:} guerra GP + decoupling + semiconductores + IA
  \item<2-> \textbf{Ucrania:} guerra GP + sanciones + orden liberal + nuclear
  \item<3-> \textbf{Clima:} cooperación + Norte--Sur + globalización tecnológica
  \item<4-> \textbf{IA:} nuevas fronteras + globalización + competencia EEUU--China
\end{itemize}

\vspace{10pt}
\onslide<5->{\centering\small \textit{Los debates no son compartimentos: son la misma red vista desde \'angulos distintos}}
\end{frame}
% ----------------------------------------------------
...
% ----------------------------------------------------
\begin{frame}
\frametitle{¿Qué se llevan del curso?}
\centering

\begin{itemize}
  \setlength{\itemsep}{6pt}
  \item<1-> Un \textbf{marco analítico} (I--I--I) que se aplica a cualquier problema
  \item<2-> Herramientas específicas: bargaining, acción colectiva, interdependencia
  \item<3-> Casos históricos que iluminan el presente
  \item<4-> Cuidado con las respuestas simples y las predicciones fáciles
  \item<5-> Criterios para leer la prensa con ojos críticos
\end{itemize}
\end{frame}
% ----------------------------------------------------
\note{Lo que nos llevamos del curso. El marco I--I--I es lo más importante: una forma de pensar que se aplica a cualquier problema de política mundial. Herramientas específicas: bargaining model (tema 03), acción colectiva (temas 06, 13), interdependencia armada (tema 08), modelos de economía política (tema 07). Casos históricos: Múnich, Cuba, Vietnam, Guerra Fría, posguerra fría. Una dosis de humildad: los analistas no predijeron ni el fin de la URSS, ni el 11-S, ni la pandemia, ni la guerra de Ucrania; cuidado con las predicciones. Y criterios para leer prensa: qué actores, qué intereses, qué instituciones, qué incentivos.}

% ----------------------------------------------------
\begin{frame}
\centering
\vspace{2em}
{\large De los cinco debates, \textbf{¿cuál creen que definirá m\'as\\ la d\'ecada 2026--2036?}}

\vspace{1.5em}
\onslide<2->{\small Justifiquen con el marco I--I--I}
\end{frame}
% ----------------------------------------------------
...
\centering
\vspace{3em}
{\LARGE Gracias\\[10pt] \large ¿Preguntas?}
