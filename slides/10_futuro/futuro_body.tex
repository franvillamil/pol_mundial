...
\begin{itemize}
  ...
  \item Desafíos al orden liberal: populismo y globalización
  \item Potencias emergentes: China y la transición de poder
  \item Armas de destrucción masiva y ciberamenazas
\end{itemize}
\end{frame}
% ----------------------------------------------------
\note{}
...
\hline
Medio ambiente & Aire limpio, nadie paga & Dilema del prisionero global & Montreal, París \\[5pt]
Orden liberal & Comercio y estabilidad & Populismo: perdedores reaccionan & ONU, OMC bajo presión \\[5pt]
China & Hegemonía vs.~influencia & Trampa de Tucídides & OTAN, G20, interdependencia \\[5pt]
Armas & Seguridad vs.~estabilidad & Disuasión, proliferación & TNP, OIEA, START \\[3pt]
\end{tabularx}

\end{frame}
% ----------------------------------------------------
\note{Slide de síntesis que conecta los cuatro temas de hoy con el marco analítico del curso: intereses, interacciones, instituciones (el marco I-I-I de FLS). El objetivo es que los estudiantes vean que las herramientas analíticas del curso se aplican a todos estos problemas. Medio ambiente: los intereses están claros (todos quieren un planeta habitable), pero la interacción es un dilema del prisionero masivo, y las instituciones (tratados, mercados de carbono) intentan facilitar la cooperación. Orden liberal: los intereses de los ganadores y perdedores de la globalización divergen, la interacción produce populismo, y las instituciones del orden de posguerra están bajo presión. China: los intereses de EE.UU.~(mantener la hegemonía) y China (ganar influencia) chocan, la interacción puede llevar a la trampa de Tucídides, y las instituciones existentes pueden (o no) prevenir la guerra. Armas: la seguridad nacional choca con la estabilidad global, la disuasión funciona bajo ciertas condiciones, y los regímenes de no proliferación intentan contener la amenaza. Este es el último slide de contenido del curso. Los estudiantes deberían poder aplicar este marco a cualquier problema de política mundial.}
