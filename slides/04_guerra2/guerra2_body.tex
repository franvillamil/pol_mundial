...
% ----------------------------------------------------
% IMAGE: democratic_peace -- Gráfico o matriz mostrando la ausencia de guerras entre democracias consolidadas (ver FLS Figure 4.4 o similar). Sirve para abrir la sección con la evidencia empírica.
...
% ----------------------------------------------------
% IMAGE: un_peacekeeping_map -- Mapa mundial mostrando las operaciones de paz de la ONU activas, o un gráfico de barras/timeline mostrando la explosión de misiones de paz desde 1990. Buscar en la web de la ONU (peacekeeping.un.org).
% TODO: uncomment when image is available
% \begin{frame}[plain]
%   \begin{tikzpicture}[remember picture, overlay]
%     \node[at = (current page.center), yshift = 0cm] (cover) {%
%       \includegraphics[keepaspectratio, height=\paperheight]{../img/un_peacekeeping_map}};
%   \end{tikzpicture}
% \end{frame}
% % ----------------------------------------------------
