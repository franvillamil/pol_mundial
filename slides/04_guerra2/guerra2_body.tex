...
\begin{itemize}
  ...
  \item La política doméstica y la guerra
  \item La paz democrática
  \item Alianzas
  \item Seguridad colectiva
\end{itemize}
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Semana pasada}
\centering

\includegraphics[width = \textwidth]{../img/bargaining_model}
...
\begin{itemize}
  ...
  \item<3-> ¿Puede haber actores que \textit{se beneficien} de la guerra?
    \begin{itemize}
    \item La otra pregunta es si hay actores \textit{reacios} a la guerra con suficiente poder para pararla
  \end{itemize}
\end{itemize}
...
\begin{tikzpicture}[scale=1.2]
  ...
  % Side labels
  \node[font=\tiny\itshape, asher, anchor=west] at (2.8, 3.6) {Deciden};
  \node[font=\tiny\itshape, asher, anchor=west] at (2.8, 2.2) {Asesoran e implementan};
  \node[font=\tiny\itshape, asher, anchor=west] at (2.8, 0.7) {Influyen y pagan costes};
\end{tikzpicture}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=0.8\paperheight]{../img/rally_effect_approval.png}};
    \node[at = (current page.center), yshift = 4.2cm] (cover) {%
      \large Aprobación de Bush};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{Bush}
...
\begin{itemize}
  \item \textbf{Efecto rally 'round the flag:} la opinión pública tiende a apoyar al gobierno ante una crisis internacional
...
% ----------------------------------------------------
\begin{frame}
\frametitle{¿Funciona la guerra diversoria? (\textit{diversionary war})}
\centering
...
\begin{itemize}
  ...
  \end{itemize}
  \item<3-> \textit{Gambling for resurrection}: apostar cuando ya no hay nada que perder
\end{itemize}
...
% ----------------------------------------------------
\imageframe{../img/warsofothers1}
\note{}
% ----------------------------------------------------

% ----------------------------------------------------
\imageframe{../img/warsofothers2}
\note{}
% ----------------------------------------------------
...
¿Y si los que deciden la guerra son también quienes se benefician de ella?
\end{transitionframe}
% ----------------------------------------------------
\note{}
...
\begin{itemize}
  ...
  \end{itemize}
  \item<4-> Pero: no todos los militares son belicistas
  \begin{itemize}
    \item {\scriptsize Los generales de Bush fueron más cautos que los civiles sobre Irak en 2003}
  \end{itemize}
\end{itemize}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=\paperheight]{../img/malvinas_1982}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{Bush}
...
\vspace{15pt}
¿Qué actores domésticos influyeron y qué esperaban ganar?
...
% ----------------------------------------------------
% Remove this transitionframe when the image below is uncommented
\begin{transitionframe}
¿Puede el tipo de régimen político influir en la probabilidad de guerra?
\end{transitionframe}
% ----------------------------------------------------
\note{}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=\paperheight]{../img/kant}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{larga historia}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=\paperheight]{../img/democratic_peace}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{Visualización de la paz democrática: la ausencia (o casi ausencia) de guerras entre democracias consolidadas. Dejar que los estudiantes observen el patrón antes de explicarlo.}
...
Rendición de cuentas & Los líderes democráticos pagan costes políticos más altos por guerras costosas o perdidas \\[4pt]
\onslide<2->{Transparencia & Los procesos democráticos son más abiertos: prensa libre, debate legislativo, oposición. Reduce la incertidumbre} \\[4pt]
\onslide<3->{Señales creíbles & Las amenazas de líderes democráticos son más creíbles (costes de audiencia mayores)} \\[4pt]
\onslide<4->{Normas compartidas & Las democracias se perciben como parte de una ``comunidad'' que resuelve disputas pacíficamente} \\
\onslide<5->{ & \textbf{(Factor estático vs evolución histórica?)} }
\end{tabular}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0.5cm] (cover) {%
      \includegraphics[keepaspectratio, height=0.9\paperheight]{../img/demopeacemodel_triangle}};
      \node[at = (current page.center), yshift = -4.4cm] (cover) {%
      \footnotesize Altman, Rojas-de-Galarreta \& Urdinez (2020, ``An interactive model of democratic peace'')};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=\paperheight]{../img/demopeacemodel1}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=\paperheight]{../img/demopeacemodel2}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=\paperheight]{../img/cederman2001}};
      \node[at = (current page.center), yshift = 3.8cm, xshift = 3.5cm] (cover) {%
      \footnotesize Cederman (2001, ``Back to Kant'')};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{historical learning}
...
% Remove this transitionframe when the image below is uncommented
\begin{transitionframe}
Si actuar solo es peligroso, ¿qué pasa cuando los Estados se coordinan?
\end{transitionframe}
% ----------------------------------------------------
\note{}
...
{\large Las alianzas son selectivas: ¿qué pasa con los Estados que quedan fuera?}

\vspace{15pt}
\footnotesize ¿Es posible un sistema donde \textit{todos} se protejan mutuamente?

\end{frame}
% ----------------------------------------------------
\note{Pregunta de transición entre alianzas y seguridad colectiva. Las alianzas protegen a sus miembros pero dejan fuera a los demás. ¿Qué pasa si un Estado sin alianza poderosa es atacado? Las alianzas también pueden dividir el mundo en bloques enfrentados (como en la Guerra Fría). La idea de la seguridad colectiva surge precisamente de esta limitación: en vez de protección selectiva, protección universal. Pero como veremos, tiene sus propios problemas.}
...
% Remove this transitionframe when the image below is uncommented
\begin{transitionframe}
¿Y si todos los Estados prometieran defender a cualquiera que sea atacado?
\end{transitionframe}
% ----------------------------------------------------
\note{}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=\paperheight]{../img/cascos_azules}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{cascos azules}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=0.9\paperheight]{../img/un_peacekeeping_map}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{Mapa (o gráfico temporal) de las operaciones de paz de la ONU. Desde 1990, el número de misiones se ha multiplicado. Visualiza la expansión del concepto de seguridad colectiva más allá de las guerras interestatales.}

% ----------------------------------------------------
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=.95\paperheight]{../img/UN_PK_troops_1947_2014_A}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{UN PK evolution}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=.95\paperheight]{../img/UN_PK_troops_1947_2014_B}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{UN PK evolution}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[at = (current page.center), yshift = 0cm] (cover) {%
      \includegraphics[keepaspectratio, height=.95\paperheight]{../img/UN_PK_troops_1947_2014_C}};
  \end{tikzpicture}
\end{frame}
% ----------------------------------------------------
\note{UN PK evolution}
...
\centering
\textbf{Peacekeeping}\\
{\scriptsize (mantenimiento de paz)}

\vspace{8pt}
\footnotesize
\begin{itemize}
  \item Cascos azules, ligeramente armados
  \item Separar combatientes tras un alto el fuego
  \item \textbf{Requiere} consentimiento
\end{itemize}
\end{column}
\begin{column}{0.45\textwidth}
\centering
\onslide<2->{\textbf{Peace enforcement}\\
{\scriptsize (imposición de paz)}
...
\begin{itemize}
  ...
  \item \textbf{No requiere} consentimiento
\end{itemize}}
\end{column}
\end{columns}
...
\begin{itemize}
  ...
  \item<2-> \textbf{Interacciones:} la democracia cambia cómo interactúan los Estados
  \begin{itemize}
    \item Transparencia, señales creíbles, rendición de cuentas $\rightarrow$ paz democrática
  \end{itemize}
