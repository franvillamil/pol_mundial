...
\begin{itemize}
  \item \textbf{Dentro del Estado:} líderes, militares y grupos de interés pueden ampliar las ambiciones del Estado
  \item Efecto rally, incentivo diversorio, complejo militar-industrial
  \item<2-> \textbf{Paz democrática:} las democracias casi nunca luchan entre sí
  \item<2-> Rendición de cuentas, transparencia, normas compartidas
  \item<3-> \textbf{Alianzas y seguridad colectiva:} influyen en la negociación cambiando expectativas, credibilidad y costes de la guerra
\end{itemize}
