...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Rentas generan \alert{corrupci\'{o}n} y \alert{rent-seeking}
...
\vspace{4pt}
{\scriptsize \% de la poblaci\'{o}n total con derecho a voto}
...
\begin{itemize}
  ...
  \end{itemize}
  \vspace{8pt}
  \item<4-> \textbf{Ejemplo: algod\'{o}n}
  \begin{itemize}
    \item EE.UU.\ subsidia a sus productores de algod\'{o}n con \textbf{miles de millones \$}
    \item Esto hunde el precio mundial del algod\'{o}n
    \item Los agricultores africanos (Mal\'{i}, Burkina Faso) no pueden competir
  \end{itemize}
\end{itemize}
...
% ----------------------------------------------------
\begin{frame}
\frametitle{ISI: Industrializaci\'{o}n por Sustituci\'{o}n de Importaciones}
\centering
...
\begin{itemize}
  ...
  \end{itemize}
  \vspace{8pt}
  \item<4-> Clave: \alert{Estado desarrollista} --- no laissez-faire
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    Mayor en \% del PIB: pa\'{i}ses escandinavos
  \end{itemize}
  \vspace{8pt}
...
{\footnotesize
\begin{adjustbox}{width=\textwidth}
\begin{tabular}{>{\bfseries}p{2.2cm} p{3cm} p{2.5cm} p{2.5cm}}
...
\vspace{8pt}
\onslide<2->{\small \textbf{Banerjee y Duflo} (Nobel 2019): ni gran empuj\'{o}n ni laissez-faire\\ $\rightarrow$ \alert{intervenciones espec\'{i}ficas basadas en evidencia} (RCTs)}
...
\begin{itemize}
  ...
  \end{itemize}
  \vspace{8pt}
  \item<4-> \alert{Optimismo cauteloso}: la pobreza extrema ha ca\'{i}do dr\'{a}sticamente
  \begin{itemize}
