...
% ====================================================
\section{Interdependencia armada}
% ====================================================
...
% ----------------------------------------------------
\begin{frame}
\frametitle{Interdependencia armada (\textit{weaponized interdependence})}
\centering

\begin{itemize}
  \item Farrell y Newman (2019): las redes económicas globales tienen \textbf{estructura de hub}
  \begin{itemize}
  ...
  \begin{itemize}
    \item \textbf{Efecto panóptico:} vigilar los flujos (inteligencia financiera)
    \item \textbf{Efecto estrangulamiento:} cortar el acceso a la red (sanciones)
  \end{itemize}
  \vspace{8pt}
  \item<3-> Nodos clave controlados por EE.UU.:
  \begin{itemize}
